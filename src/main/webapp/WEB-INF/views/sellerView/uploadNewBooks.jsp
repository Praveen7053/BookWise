<div class="container-fluid vh-100 d-none flex-column justify-content-center align-items-center" id="mainUploadNewBooksPageMainDIV" style="display: none;">
    <div class="card shadow border-0 rounded-4 w-100 mx-3" style="max-width: 1280px; height: 95vh; overflow: hidden;">
        ...
        <div class="card-body p-3 overflow-auto">
            ...
            <div class="d-grid">
                <button type="submit" onclick="handleUploadBook();" class="btn btn-primary btn-lg rounded-3">Upload Book</button>
            </div>
        </div>
    </div>
</div>
